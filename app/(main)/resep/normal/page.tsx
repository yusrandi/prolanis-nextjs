...
import { database, resepNormalRef } from '../../../../lib/firebase';
...
export default function ResepNormalPage() {
    ...
    const saveResep = () => {
        ...
        // console.log({ tip });
        set(ref(database, 'reseps/resepnormal/' + uid), {
            uid: uid,
            bahan: resep.bahan,
            cara: resep.cara,
            image: resep.image,
    ...
    const deleteResep = () => {
        ...
        remove(ref(database, 'reseps/resepnormal/' + resep.uid))
            .then(() => {
                setDeleteResepDialog(false);
                setResep(emptyResep);
                toast.current?.show({
